...
namespace EPED
{
    class ColorUtils
    {
        ...
        public static String getColorNameFromRgb(int r, int g, int b)
        {
            ...
            int minMSE = (Int32)Math.Pow(2,24); // cast as 32 bit integer
            int mse;
        ...
        //{
        //    return Int32.decode("0x"
        //            + Integer.toHexString(c.getRGB()).substring(2));
        //}

        //public String getColorNameFromColor(Color colr)
        //{
        //    return getColorNameFromRgb(colr.getRed(), colr.getGreen(),
        //            color.getBlue());
        //}
