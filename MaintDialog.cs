...
namespace EPED
{
    ...
    public partial class MaintDialog : Form
    {
        ...
        //'ADD TO' button
        private void btnAddNew_MouseMove(object sender, MouseEventArgs e)
        {
            btnAddNew.ForeColor = Globals.selectBtnfgCol;
        ...
        {
            btnAddNew.ForeColor = Color.FromArgb(((int)(((byte)(249)))), ((int)(((byte)(228)))), ((int)(((byte)(229)))));
            btnAddNew.BackColor = Color.FromArgb(((int)(((byte)(207)))), ((int)(((byte)(41)))), ((int)(((byte)(47)))));
        }

        //'SET NEXT DUE' button
        private void btnSetNextDueDate_MouseMove(object sender, MouseEventArgs e)
        {
            btnSetNextDueDate.ForeColor = Globals.selectBtnfgCol;
            btnSetNextDueDate.BackColor = Color.LightCoral;
        }

        //'SET NEXT DUE' button
        private void btnSetNextDueDate_MouseLeave(object sender, EventArgs e)
        {
            btnSetNextDueDate.ForeColor = Color.FromArgb(((int)(((byte)(249)))), ((int)(((byte)(228)))), ((int)(((byte)(229)))));
            btnSetNextDueDate.BackColor = Color.FromArgb(((int)(((byte)(207)))), ((int)(((byte)(41)))), ((int)(((byte)(47)))));
        }
